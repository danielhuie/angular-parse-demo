...
angular.module('ToDoApp', ['ui.bootstrap'])
    .config(function($httpProvider) {
        ...
        $httpProvider.defaults.headers.common['X-Parse-Application-Id'] = 'LldqAEX91CEav4WKBhm1GwA1fDTTEdF60niyj644';
        $httpProvider.defaults.headers.common['X-Parse-REST-API-Key'] = 'KQLWHluP9n2f9dxXlt2hCh8TQWrEhA9KQmTMBDms';
    })
